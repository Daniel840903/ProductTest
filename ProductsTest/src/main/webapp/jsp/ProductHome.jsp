...
<body>
    ...
    <div class="row2">
        <form action="./DemoProductServletAction" method="post">
            ...
            <input type="text" id="productid" name="productid" placeholder="請输入ID" required> 
            <label for="productName">產品名稱:</label> 
            <input type="text" id="productName" name="productName" placeholder="請输入產品名"> 
            <label for="price">價格:</label>
            <input type="text" id="price" name="price" placeholder="請输入價格">
            <label for="description">產品描述:</label>
            <textarea id="description" name="description" placeholder="請输入描述"></textarea>
            <label for="stockQuantity">庫存數量:</label> 
            <input type="text" id="stockQuantity" name="stockQuantity" placeholder="請输入數量">
            <input class="btn2" type="submit" value="更新">
        </form>
    </div>

    <script>
    function editProduct(productid) {
        window.location.href = './jsp/ProductUpdate.jsp?productid=' + productid; 
    }
